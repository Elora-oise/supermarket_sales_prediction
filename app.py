...
print("OS directory set successfully")

# Loading the trained Model
model_path = os.path.join(script_dir, "random_forest_sales_model.pkl")
model = joblib.load(model_path)
print("Sales Model Loaded Successfully")

# Loading the trained Model
scaler_path = os.path.join(script_dir, "sales_scaler.pkl")
scaler = joblib.load(scaler_path)
print("Sales Scaler Loaded Successfully")

# Loading Image
image_path = os.path.join(script_dir, "supermarket_sales.jpeg")
